...
class BagDP:
    ...
    def two_dimension_limited(m, n, nums):
        ...
        for duplicate, b in nums:
            for i in range(m, duplicate - 1, -1):
                for j in range(n, b - 1, -1):
                    dp[i][j] += dp[i - duplicate][j - b]
        return dp[m][n]
    ...
    def one_dimension_limited_use_dct(nums):
        ...
        # using duplicate dictionary for transfer records with negative numbers
