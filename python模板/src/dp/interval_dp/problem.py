...
2430. 对字母串可执行的最大删除数（https://leetcode.cn/problems/maximum-deletions-on-duplicate-string/）最长公共前缀DP加线性DP
1547. 切棍子的最小成本（https://leetcode.cn/problems/minimum-cost-to-cut-duplicate-stick/）区间DP模拟
...
1312. 让字符串成为回文串的最少插入次数（https://leetcode.cn/problems/minimum-insertion-steps-to-make-duplicate-string-palindrome/）经典区间DP，最长回文子序列
...
class Solution:
    ...
    def lg_p2734(ac=FastIO()):
        ...
        #     return res
        # duplicate = dfs(0, n-1)
        # ac.lst([duplicate, pre[-1]-duplicate])
