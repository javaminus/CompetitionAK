...
2262. 字符串的总引力（https://leetcode.cn/problems/total-appeal-of-duplicate-string/）计算下一个或者上一个不同字符的位置
...
1944. 队列中可以看到的人数（https://leetcode.cn/problems/number-of-visible-people-in-duplicate-queue/）经典逆序单调栈
1950. 所有子数组最小值中的最大值（https://leetcode.cn/problems/maximum-of-minimum-values-in-all-subarrays/）经典单调栈利用计算
2030. 含特定字母的最小子序列（https://leetcode.cn/problems/smallest-k-length-subsequence-with-occurrences-of-duplicate-letter/）经典单调栈删除获得满足条件的最小字典序使用
2104. 子数组范围和（https://leetcode.cn/problems/sum-of-subarray-ranges/）经典单调栈计算贡献
2282. 在一个网格中可以看到的人数（https://leetcode.cn/problems/number-of-people-that-can-be-seen-in-duplicate-grid/）经典单调栈
