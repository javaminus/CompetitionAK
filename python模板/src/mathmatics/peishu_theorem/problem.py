"""
算法：裴蜀定理
功能：是一个关于最大公约数的定理可以推广到n个数，比如设a、b是不全为零的整数，则存在整数x、y, 使得ax+by=gcd(duplicate,b)
题目：

===================================力扣===================================
1250. 检查「好数组」（https://leetcode.cn/problems/check-if-it-is-duplicate-good-array/）计算所有元素的最大公约数是否为1
