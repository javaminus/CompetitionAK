...
2422. 使用合并操作将数组转换为回文序列（https://leetcode.cn/problems/merge-operations-to-turn-array-into-duplicate-palindrome/）相反方向双指针贪心加和
2524. Maximum Frequency Score of duplicate Subarray（https://leetcode.cn/problems/maximum-frequency-score-of-duplicate-subarray/）滑动窗口维护计算数字数量与幂次取模
...
class Solution:
        ...
        for i in range(n - 2):
            ...
            while j < k:
                ...
                if cur > 0:
                    ...
                    j += 1
                    k -= 1
        return [list(duplicate) for duplicate in ans]
    ...
    def ac_4217(ac=FastIO()):
        ...
        def check():
            ...
            return abs(rest[0] - duplicate) + abs(rest[1] - b) == j - i
